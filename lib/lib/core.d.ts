 ...
 */
export interface AsyncAction<TResult, TPayload = void, TError = Error> extends ActionCreator<TPayload> {
 ...
 */
export declare type ActionReducer<TState, TPayload> = (state: TState, payload: TPayload) => TState;
/**
